...
# Use relative paths instead of /content/ (which is Colab-specific)
svc_model = joblib.load('svc_model.joblib')
tfidf_vectorizer = joblib.load('tfidf_vectorizer.joblib')
print("SVC model and TF-IDF vectorizer loaded successfully.")

# Define the remove_stopwords function (you need to implement this)
def remove_stopwords(text):
    # Simple stopwords removal - you should use your actual implementation
...
def home():
    return jsonify({'message': 'SVC Model API is running', 'status': 'ok'})
